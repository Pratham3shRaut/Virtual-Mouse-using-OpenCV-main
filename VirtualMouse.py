...
screen_width, screen_height = pyautogui.screen.size()      # Getting the screen size
while True:
    ...
    if len(lmlist)!=0:
        ...
        if fingers[1] == 1 and fingers[2] == 0:     # If fore finger is up and middle finger is down
            ...
            pyautogui.mouse.move(screen_width - curr_x, curr_y)    # Moving the cursor
        ...
        if fingers[1] == 1 and fingers[2] == 1:     # If fore finger & middle finger both are up
            ...
            if length < 40:     # If both fingers are really close to each othecler
                cv2.circle(img, (lineInfo[4], lineInfo[5]), 15, (0, 255, 0), cv2.FILLED)
                pyautogui.mouse.click()    # Perform Click
